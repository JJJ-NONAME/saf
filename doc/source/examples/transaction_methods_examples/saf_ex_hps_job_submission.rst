...
.. tip::
  ...
  - Checkout the full backend code of the example in the `example solution <https://github.com/ansys/saf/tree/main/examples/blob/main/src/ansys/solutions/examples/solution/hps_job_submission_step.py>`__.
  - Checkout the full frontend code of the example in the `example solution <https://github.com/ansys/saf/tree/main/examples/blob/main/src/ansys/solutions/examples/ui/pages/hps_job_submission_page.py>`__.
