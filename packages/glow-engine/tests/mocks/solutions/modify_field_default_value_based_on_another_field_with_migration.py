...
class MigrateFieldValue(MigrationTransformation):
    def migrate(self, ctx: MigrationContext) -> None:
        ctx.steps["first_step"]["x"] += int(ctx.steps["first_step"]["str_int"])
...
class OriginalSolution(Solution):
    ...
    migrations: list[Migration] = [
        ...
        Migration(version=2, migration_transformation=MigrateFieldValue()),
    ]
