...
class MigrateDisplayName(MigrationTransformation):
    def migrate(self, ctx: MigrationContext):
        ctx.solution["display_name"] = "NotOriginal"
...
class OriginalSolution(Solution):
    version: int = 3
    display_name: str = "NotOriginal"
    steps: Steps
    migrations: list[Migration] = [
        Migration(version=1, migration_transformation=MigrateToVersion2()),
        Migration(version=2, migration_transformation=MigrateDisplayName()),
    ]
