...
class MigrateAddField(MigrationTransformation):
    def migrate(self, ctx: MigrationContext):
        ctx.steps["second_step"]["extra_value"] = "my_value"
        ctx.steps["second_step"]["state"]["extra_value"] = FieldState.UPTODATE
...
class OriginalSolution(Solution):
    ...
    migrations: list[Migration] = [
        ...
        Migration(version=2, migration_transformation=MigrateAddField()),
    ]
