...
class MigrateFieldType(MigrationTransformation):
    def migrate(self, ctx: MigrationContext) -> None:
        ctx.steps["first_step"]["my_string"] = ctx.steps["first_step"]["x"]
...
class OriginalSolution(Solution):
    ...
    migrations: list[Migration] = [
        ...
        Migration(version=2, migration_transformation=MigrateFieldType()),
    ]
