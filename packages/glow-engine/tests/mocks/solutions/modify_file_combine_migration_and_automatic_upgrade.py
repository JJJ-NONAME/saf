...
class CombineFileMigrationAndUpgrade(MigrationTransformation):
...
class OriginalSolution(Solution):
    ...
    steps: Steps
    migrations: list[Migration] = [Migration(version=1, migration_transformation=CombineFileMigrationAndUpgrade())]
