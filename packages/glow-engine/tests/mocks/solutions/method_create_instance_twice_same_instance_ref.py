...
class MyStep(StepModel):
    ...
    # references to the x instance
    @transaction()
    @create_instance("x", EmptyInstanceManager, identifier="a")
    @create_instance("x", EmptyInstanceManager, identifier="b")
...
class MethodCreateInstanceTwiceSameInstanceReference(Solution):
    display_name: str = "Method: @create_instance twice referring to the same instance"
    steps: Steps
