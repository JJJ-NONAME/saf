...
class MyStep(StepModel):
    ...
    # method parameter 'x' is not declared as an EmptyInstanceManager
    @transaction()
...
class MethodCreateInstanceMethodParameterWrongType(Solution):
    display_name: str = "Method: @create_instance - method parameter wrong type"
    steps: Steps
