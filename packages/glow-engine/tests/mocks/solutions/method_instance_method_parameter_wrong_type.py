...
class MyStep(StepModel):
    ...
    # the method's x parameter is not EmptyInstanceManager
    @transaction()
    @instance("x")
...
class MethodInstanceMethodParameterWrongType(Solution):
    display_name: str = "Method: @instance - method parameter is wrong type"
    steps: Steps
