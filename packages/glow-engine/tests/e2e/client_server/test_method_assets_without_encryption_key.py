...
from tests.mocks.solution_without_encryption_key.solution_with_method_assets_without_encryption_key import (
    SolutionAssetsWithoutEncryptionKey,
)

pytestmark = pytest.mark.parametrize("solution_type", [SolutionAssetsWithoutEncryptionKey], indirect=True)


def test_always_decrypted_asset(function_project: ProjectFixture[SolutionAssetsWithoutEncryptionKey]):
...
def test_decrypted_for_debug_asset(function_project: ProjectFixture[SolutionAssetsWithoutEncryptionKey]):
...
def test_asset_dir(function_project: ProjectFixture[SolutionAssetsWithoutEncryptionKey]):
