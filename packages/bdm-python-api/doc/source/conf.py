...
from ansys.bdm.api import __version__
...
if switcher_version != "dev":
    linkcheck_ignore.append(
        f"https://github.com/ansys/bdm-python-api/releases/tag/v{__version__}"
    )
...
html_theme_options = {
    "github_url": "https://github.com/ansys/saf/tree/main/packages/bdm-python-api",
...
html_theme_options["switcher"] = {
    "json_url": f"https://{cname}/version/stable/api/bdm-python-api/versions.json",
...
def _rename_api_title(app, docname, source):
    ...
    if docname == "ansys/bdm/api/index":
        old_title = "The ``ansys.bdm.api`` library"
